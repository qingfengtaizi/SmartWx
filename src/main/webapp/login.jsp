        ...
        <div class="login-input">
            <form class="bs-example bs-example-form" role="form" id="login_form">
                <div class="input-group">
                    <h2>登录名</h2>
                    <input type="text" name="username" class="form-control box-radius">
                </div>
                <div class="input-group">
                    <h2>密码</h2>
                    <input type="password" name="password" class="form-control box-radius">
                </div>
                <div class="checkbox">
                    <label>
...
<script src="<%=path%>/res/js/plugins/layer/layer.js"></script>

<script src="<%=path%>/res/js/web/common.js"></script>

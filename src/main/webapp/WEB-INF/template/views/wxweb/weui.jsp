...
<script type="text/javascript" src="<%=path %>/res/js/common/jquery.js"></script>
<script type="text/javascript" src="<%=path %>/res/js/web/login.js"></script>


<link href="<%=path %>/res/js/plugins/jqueryweiui/css/weui.min.css" rel="stylesheet" type="text/css"/>
<link href="<%=path %>/res/weui/example.css" rel="stylesheet" type="text/css"/>
</head>
<body ontouchstart>
        ...
        <div class="weui_grids">
            <a href="javascript:;" class="weui_grid js_grid" data-id="button">
                <div class="weui_grid_icon">
                    <img src="<%=path %>/res/css/images/icon_nav_button.png" alt="">
                </div>
            ...
            <a href="javascript:;" class="weui_grid js_grid" data-id="cell">
                <div class="weui_grid_icon">
                    <img src="<%=path %>/res/css/images/icon_nav_cell.png" alt="">
                </div>
                <p class="weui_grid_label">
                    Cell
                </p>
            ...
            <a href="javascript:;" class="weui_grid js_grid" data-id="toast">
                <div class="weui_grid_icon">
                    <img src="<%=path %>/res/css/images/icon_nav_toast.png" alt="">
                </div>
                <p class="weui_grid_label">
                    Toast
                </p>
            ...
            <a href="javascript:;" class="weui_grid js_grid" data-id="dialog">
                <div class="weui_grid_icon">
                    <img src="<%=path %>/res/css/images/icon_nav_dialog.png" alt="">
                </div>
                <p class="weui_grid_label">
                    Dialog
                </p>
            ...
            <a href="javascript:;" class="weui_grid js_grid" data-id="msg">
                <div class="weui_grid_icon">
                    <img src="<%=path %>/res/css/images/icon_nav_msg.png" alt="">
                </div>
                <p class="weui_grid_label">
                    Msg
                </p>
            ...
            <a href="javascript:;" class="weui_grid js_grid" data-id="article">
                <div class="weui_grid_icon">
                    <img src="<%=path %>/res/css/images/icon_nav_article.png" alt="">
                </div>
                <p class="weui_grid_label">
                    Article
                </p>
            ...
            <a href="javascript:;" class="weui_grid js_grid" data-id="actionsheet">
                <div class="weui_grid_icon">
                    <img src="<%=path %>/res/css/images/icon_nav_actionSheet.png" alt="">
                </div>
                <p class="weui_grid_label">
                    ActionSheet
                </p>
            ...
            <a href="javascript:;" class="weui_grid js_grid" data-id="icons">
                <div class="weui_grid_icon">
                    <img src="<%=path %>/res/css/images/icon_nav_icons.png" alt="">
                </div>
                <p class="weui_grid_label">
                    Icons
                </p>
    ...
    <div class="bd">
        ...
        <div class="weui_cells weui_cells_form">
            ...
            <div class="weui_cell weui_vcode">
                ...
                <div class="weui_cell_ft">
                    <img src="<%=path %>/res/css/images/vcode.jpg" />
                </div>
            </div>
            <div class="weui_cell">
...
<div class="page">
    ...
    <script src="<%=path %>/res/weui/zepto.min.js"></script>
    <script src="<%=path %>/res/weui/example.js"></script>
</body>
</html>

...
<!--引入自定义js-->
<script src="<%=path%>/res/js/web/editsinglenews.js"></script>
              ...
              <div class="graMain">
                  <dl class="graLeft">
                      ...
                      <dd class="graContainer">
                              <!-- 标题 -->
                              <input type="hidden" id="left_title"  value="${newsObj.title}">
                              <!-- 图文消息的封面图片素材id（必须是永久mediaID） -->
                              <input type="hidden" id="left_thumb_media_id"  value="${newsObj.thumbMediaId}">
                              <!-- 作者 -->	 
                              <input type="hidden" id="left_author" value="${newsObj.author}">
                              <!--图文消息的摘要，仅有单图文消息才有摘要，多图文此处为空 -->
                              <input type="hidden" id="left_digest" value="${newsObj.brief}">
                              <!--是否显示封面，0为false，即不显示，1为true，即显示  -->
                              <input type="hidden" id="left_show_cover_pic" value="${newsObj.showpic}">
                              <!-- 内容 -->
                              <input type="hidden" id="left_content" value="${newsObj.description}">
                              <!-- 图文消息的原文地址，即点击“阅读原文”后的URL -->
                              <input type="hidden" id="left_content_source_url" value="${newsObj.url}">
                              
                              <!--封面图片访问地址 -->
                              <input type="hidden" id="left_mainImage" value="${newsObj.picpath}">
                  ...
                  <input type="hidden" id="mediaId" value="${newsObj.mediaId}">
                  <div class="graMid">
                      
                      <div class="titleInput"><span>请输入标题：</span>
                         <input type="text" placeholder="标题" id="title" style="width:80%" 
                         onkeyup="inputTitle()" onblur="checkTitle(this)" value="${newsObj.title}">
                         <br>
                         <!-- 标题的非空提示 -->
                      ...
                      <ul class="graStyleEdite">
                          ...
                          <li class="li02">
                              <dl>
                                  ...
                                  <dd>
                                     <textarea  id="digest"  onblur="checkDigest(this)">${newsObj.brief}</textarea>
                                  </dd>
                              </dl>

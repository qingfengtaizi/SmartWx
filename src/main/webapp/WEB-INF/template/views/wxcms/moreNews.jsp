...
<!--引入自定义js-->
<script src="<%=path%>/res/js/web/morenews.js"></script>
...
<div class="main">
 ...
 <div class="rightInfo">
  <div class="graPage">
                  ...
                  <dl class="graLeft">
                      ...
                      <dd class="graContainer">
                          <div class="graBig" id="now_div" onClick="fnClick(this)">
                               <input type='hidden' id='left_title_0' >
	                           <input type='hidden' id='left_thumb_media_id_0' >
	                           <input type='hidden' id='left_author_0' >
				               <input type='hidden' id='left_digest_0' >
				               <input type='hidden' id='left_show_cover_pic_0' value=0>
				               <input type='hidden' id='left_content_0' > 
				               <input type='hidden' id='left_content_source_url_0' >
				               <input type='hidden' id='left_mainImage_0' >
                               <img src="<%=path%>/res/images/img_default.png">
                               <h6>标题</h6>
                          </div>
                          
                          <div class="graAdd" onClick="addGra()">
                              <img src="<%=path%>/res/images/add_img_07.png">
                          </div>
                      </dd>
                  </dl>
            ...
            <div class="graSave">
              <input type="button" value="保存" onclick="checkMoreNews()">
            </div>        	

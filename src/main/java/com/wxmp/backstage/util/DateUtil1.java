...
public class DateUtil1 {
    ...
    public static int subMonth(String startDate, String endDate) {
        ...
        c1.setTime(DateUtil1.stringToDate(startDate, FULL_DATE_FORMAT));    
        c2.setTime(DateUtil1.stringToDate(endDate, FULL_DATE_FORMAT)); 
        while (!c1.after(c2)) {  
        	result++;
    ...
    public static void main(String[] args) {
    	...
    	int l = DateUtil1.subMonth(startDate, endDate);
